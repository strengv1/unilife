      ...
      <div className="container mx-auto max-w-4xl px-8">
        ...
        <div className="mt-4 md:mt-6 grid gap-8 grid-cols-2">
          ...
          <Card className="border-2 border-slate-400 bg-gradient-to-b from-slate-50 to-white transform transition-transform hover:scale-105 shadow-md">
            <CardContent className="pt-3 px-4 text-center">
              <h3 className="text:xl md:text-2xl font-bold">2nd Place</h3>
              <div className="my-6 text-3xl md:text-5xl font-extrabold text-slate-600">€400</div>
            </CardContent>
          </Card>
          <Card className="border-2 border-amber-700 bg-gradient-to-b from-amber-50 to-white transform transition-transform hover:scale-105 shadow-md">
            <CardContent className="pt-3 px-4 text-center">
              <h3 className="text:xl md:text-2xl font-bold">3rd-4th Place</h3>
              <div className="my-6 text-3xl md:text-5xl font-extrabold text-amber-700">€250</div>
            </CardContent>
          </Card>
          <Card className="border-2 border-amber-700 bg-gradient-to-b from-amber-50 to-white transform transition-transform hover:scale-105 shadow-md">
            <CardContent className="pt-3 px-4 text-center">
              <h3 className="text:xl md:text-2xl font-bold">5th-8th Place</h3>
              <div className="my-6 text-3xl md:text-5xl font-extrabold text-amber-700">€150</div>
            </CardContent>
          </Card>
          <Card className="border-2 border-amber-700 bg-gradient-to-b from-amber-50 to-white transform transition-transform hover:scale-105 shadow-md">
            <CardContent className="pt-3 px-4 text-center">
              <h3 className="text:xl md:text-2xl font-bold">9th-16th Place</h3>
              <div className="my-6 text-3xl md:text-5xl font-extrabold text-amber-700">€50</div>
            </CardContent>
          </Card>
        </div>
      </div>
